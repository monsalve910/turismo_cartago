                        ...
                        <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition group">
                            ...
                            <div class="p-6">
                                ...
                                <?php if($tour->esta_agotado): ?>
                                    <a href="<?php echo e(route('tours.show', $tour)); ?>" class="mt-4 block w-full text-center bg-gray-500 hover:bg-gray-600 text-white py-2 rounded-lg transition font-medium">
                                        Agotado 
                                    </a>
                                <?php else: ?>
...
<?php endif; ?><?php /**PATH C:\Users\giral\Desktop\turismo\resources\views/welcome.blade.php ENDPATH**/ ?>