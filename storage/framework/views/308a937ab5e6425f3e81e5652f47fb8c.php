...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center gap-4">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Nuevo Administrador</h2>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto">
            <div class="bg-white rounded-2xl shadow-lg p-8">
                <div class="mb-6">
                    <h3 class="text-2xl font-bold text-gray-800">Crear Nueva Cuenta</h3>
                    <p class="text-gray-500 mt-1">Asigna privilegios de administrador a un nuevo usuario</p>
                </div>

                <form action="<?php echo e(route('admin.administradores.store')); ?>" method="POST" class="space-y-6">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" id="email" required
                                   class="pl-10 block w-full rounded-xl border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 p-2.5"
                                   placeholder="admin@turismocartago.com">
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg">
                        <div class="flex items-start gap-3">
                            ...
                            <p class="text-sm text-yellow-800">Al crear este usuario, se le asignará automáticamente el rol de <strong>Administrador</strong> con acceso completo al panel.</p>
                        </div>
                    </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\turismo_cartago\resources\views/admin/administradores/create.blade.php ENDPATH**/ ?>