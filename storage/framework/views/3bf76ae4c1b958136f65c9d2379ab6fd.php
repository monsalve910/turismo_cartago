...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirm','data' => ['message' => '¿Eliminar categoría? Esto podría afectar a los tours asociados.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['message' => '¿Eliminar categoría? Esto podría afectar a los tours asociados.']); ?>
