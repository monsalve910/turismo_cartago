...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirm','data' => ['message' => '¿Estás seguro de eliminar este administrador?']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['message' => '¿Estás seguro de eliminar este administrador?']); ?>
