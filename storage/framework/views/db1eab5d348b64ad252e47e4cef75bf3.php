    ...
    <div class="py-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-orange-500 hover:shadow-xl transition">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo e($totalGuias ?? 0); ?></p>
                    </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                ...
                <a href="<?php echo e(route('admin.guias.index')); ?>" class="flex flex-col items-center gap-2 p-4 bg-amber-50 rounded-xl hover:bg-amber-100 transition group">
                    <svg class="w-8 h-8 text-amber-600 group-hover:scale-110 transition" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                    </svg>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $recentReservas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reserva): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="border-t hover:bg-gray-50 transition">
                                    ...
                                    <td class="p-4"><?php echo e($reserva->fecha_reservacion ? \Carbon\Carbon::parse($reserva->fecha_reservacion)->format('d/m/Y') : '---'); ?></td>
                                    <td class="p-4">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\turismo_cartago\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>