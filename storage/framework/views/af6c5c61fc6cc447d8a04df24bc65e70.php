                            ...
                            <div class="flex-1">
                                ...
                                <?php if($puedeCancelar): ?>
                                    <div class="mt-3 flex items-center gap-3">
                                        <form action="<?php echo e(route('reservaciones.cancelar', $reserva->id)); ?>" method="POST" onsubmit="return confirm('¿Cancelar esta reservación?')">
                                            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\giral\Desktop\turismo\resources\views/reservaciones/index.blade.php ENDPATH**/ ?>