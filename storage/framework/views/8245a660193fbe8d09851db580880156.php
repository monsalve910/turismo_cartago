...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirm','data' => ['message' => '¿Eliminar este tour?']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['message' => '¿Eliminar este tour?']); ?>
                                            <form action="<?php echo e(route('admin.tours.destroy', $tour)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
