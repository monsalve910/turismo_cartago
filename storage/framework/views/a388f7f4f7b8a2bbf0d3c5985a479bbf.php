    ...
    <div class="py-8">
        <div class="max-w-xl mx-auto">
            <div class="bg-white rounded-2xl shadow-lg p-8">
                ...
                <form action="<?php echo e(route('admin.categorias.store')); ?>" method="POST" class="space-y-5">
                    <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="name" id="name" required
                                   ...
                                   placeholder="Ej: Aventura, Cultural, Gastronómico" value="<?php echo e(old('name')); ?>">
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\apesi\turismo-cartago\resources\views/admin/categorias/create.blade.php ENDPATH**/ ?>