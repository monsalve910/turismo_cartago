...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirm','data' => ['message' => '¿ESTÁS SEGURO de eliminar esta categoría? Esta acción no se puede deshacer.']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['message' => '¿ESTÁS SEGURO de eliminar esta categoría? Esta acción no se puede deshacer.']); ?>
