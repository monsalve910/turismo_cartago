                ...
                <table width="560" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:16px;overflow:hidden;">
                    <tr>
                        <td align="center" style="padding:40px 30px 20px;">
                            ...
                            <h1 style="font-size:24px;color:#1f2937;margin:0 0 8px;">Reservación Cancelada</h1>
                            <p style="font-size:16px;color:#6b7280;margin:0 0 24px;">
                                Tu reservación para <strong style="color:#1f2937;"><?php echo e($reservacion->tour->nombre); ?></strong> ha sido cancelada por el administrador.
                            </p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td align="center" style="padding:0 30px 40px;">
                            <a href="<?php echo e(route('tours.index')); ?>" style="display:inline-block;background-color:#059669;color:#ffffff;padding:12px 24px;border-radius:12px;text-decoration:none;font-weight:600;font-size:14px;">
...
<?php /**PATH C:\Users\apesi\turismo-cartago\resources\views/emails/reservacion-cancelada.blade.php ENDPATH**/ ?>