...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.confirm','data' => ['message' => '¿ESTÁS SEGURO de eliminar este lugar?']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['message' => '¿ESTÁS SEGURO de eliminar este lugar?']); ?>
                    <form action="<?php echo e(route('admin.lugares.destroy', $lugar->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
