            ...
            <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition group">
                ...
                <div class="p-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <button disabled class="mt-4 block w-full text-center bg-gray-800 text-white py-2 rounded-lg font-medium cursor-not-allowed opacity-60">
                            Agotado
                        </button>
                        <?php else: ?>
...
<?php endif; ?><?php /**PATH C:\Users\apesi\turismo-cartago\resources\views/tours/index.blade.php ENDPATH**/ ?>