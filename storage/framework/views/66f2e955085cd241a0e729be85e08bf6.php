                ...
                <div class="border border-gray-200 rounded-xl overflow-hidden hover:shadow-md transition">
                    ...
                    <div class="p-4">
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <a href="<?php echo e(route('tours.show', $tour->id)); ?>" class="text-sm text-emerald-600 hover:text-emerald-800 font-medium">
                                Ver detalles →
                            </a>
                        </div>
                    </div>
...
<?php endif; ?><?php /**PATH C:\Users\giral\Desktop\turismo\resources\views/dashboard.blade.php ENDPATH**/ ?>