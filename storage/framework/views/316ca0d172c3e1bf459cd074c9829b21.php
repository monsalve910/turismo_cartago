...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center gap-4">
            ...
            <div>
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Nuevo Guía Turístico</h2>
                <p class="text-sm text-gray-500">Registra un nuevo guía en el sistema</p>
            </div>
        </div>
     <?php $__env->endSlot(); ?>
    ...
    <div class="py-8 max-w-xl mx-auto">
        <div class="bg-white rounded-2xl shadow-lg p-8">
            <form action="<?php echo e(route('admin.guias.store')); ?>" method="POST" class="space-y-5">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\apesi\turismo-cartago\resources\views/admin/guias/create.blade.php ENDPATH**/ ?>