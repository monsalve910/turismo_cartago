    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gradient-to-br from-emerald-50 via-teal-50 to-green-50">
            ...
            <div class="mt-6 text-center text-sm text-gray-500">
                <a href="{{ url('/') }}" class="inline-flex items-center gap-2 text-emerald-600 hover:text-emerald-800 font-medium transition group">
            ...
            <div class="mt-8 text-center text-xs text-gray-400">
                <p>© {{ date('Y') }} Turismo Cartago. Todos los derechos reservados.</p>
            </div>
        </div>
    </body>
</html>
