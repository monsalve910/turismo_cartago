    ...
    <div class="py-8">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 border-l-4 border-amber-500 hover:shadow-xl transition">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800 mt-2">{{ $totalRutas ?? 0 }}</p>
                    </div>
        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
                <a href="{{ route('admin.tours.create') }}" class="flex flex-col items-center gap-2 p-4 bg-emerald-50 rounded-xl hover:bg-emerald-100 transition group">
                ...
                <a href="{{ route('admin.rutas.create') }}" class="flex flex-col items-center gap-2 p-4 bg-blue-50 rounded-xl hover:bg-blue-100 transition group">
                ...
                <a href="{{ route('admin.lugares.index') }}" class="flex flex-col items-center gap-2 p-4 bg-indigo-50 rounded-xl hover:bg-indigo-100 transition group">
                ...
                <a href="{{ route('admin.categorias.create') }}" class="flex flex-col items-center gap-2 p-4 bg-amber-50 rounded-xl hover:bg-amber-100 transition group">
                ...
                <a href="{{ route('admin.administradores.create') }}" class="flex flex-col items-center gap-2 p-4 bg-purple-50 rounded-xl hover:bg-purple-100 transition group">
        ...
        @if(isset($recentReservas) && $recentReservas->count() > 0)
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-8">
                <h3 class="text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left">
                        ...
                        <tbody>
                            @foreach($recentReservas as $reserva)
                                <tr class="border-t hover:bg-gray-50 transition">
                                    ...
                                    <td class="p-4 text-center">
                                        <a href="{{ route('admin.reservaciones.index') }}" class="text-blue-600 hover:text-blue-800 font-medium text-sm">Ver</a>
                                    </td>
                </tr>
                            @endforeach
                        </tbody>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <a href="{{ route('admin.tours.index') }}" class="bg-white overflow-hidden shadow-lg rounded-2xl hover:shadow-xl transition group">
                <div class="p-6">
            ...
            <a href="{{ route('admin.rutas.index') }}" class="bg-white overflow-hidden shadow-lg rounded-2xl hover:shadow-xl transition group">
                <div class="p-6">
                    <div class="flex items-center">
            ...
            <a href="{{ route('admin.lugares.index') }}" class="bg-white overflow-hidden shadow-lg rounded-2xl hover:shadow-xl transition group">
                <div class="p-6">
                    <div class="flex items-center">
            ...
            <a href="{{ route('admin.categorias.index') }}" class="bg-white overflow-hidden shadow-lg rounded-2xl hover:shadow-xl transition group">
                <div class="p-6">
                    <div class="flex items-center">
            ...
            <a href="{{ route('admin.reservaciones.index') }}" class="bg-white overflow-hidden shadow-lg rounded-2xl hover:shadow-xl transition group">
                <div class="p-6">
                    <div class="flex items-center">
            ...
            <a href="{{ route('admin.administradores.index') }}" class="bg-white overflow-hidden shadow-lg rounded-2xl hover:shadow-xl transition group">
                <div class="p-6">
                    <div class="flex items-center">
